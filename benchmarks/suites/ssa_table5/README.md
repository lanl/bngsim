...
| `prion_aggregation` | 300 | 10 | Lin 2019's Fig. 7 horizon, 0 to 300 days ([#429](https://github.com/lanl/bngsim/issues/429)). The record's ten-day run is its own choice, and its protocol note now says so (`wshlavacek/BNGL-Models#45`) |

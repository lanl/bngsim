...
class ModelBuilder:
    ...
    def add_parameter(self, name: str, value: typing.SupportsFloat | typing.SupportsIndex, expression: str = '', is_expression: bool = False, is_compartment_size: bool = False, is_internal: bool = False) -> int:
        """
        Add a parameter. Returns 0-based index. is_expression=True means expression defines the value and `value` is only a seed; call order among such parameters need not be dependency order, since build() sorts them and every later re-derivation walks that order (issue #568). is_compartment_size=True marks the parameter as an SBML compartment size, whose value the loader folds into load-time constants a write cannot reach (per-species volume factors, amount-declared ICs, mass-action rate constants, SSA propensity volumes, the emitted inv_vf table), so set_param refuses a value-changing write instead of desyncing the two representations (issue #164). Default False leaves .net and every non-compartment parameter unchanged.
        """
...
class ResultCore:
    ...
    def ssa_diagnostics(self) -> SsaDiagnostics:
        ...
    @property
    def state_data(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
    @property
...
class SolverOptions:
    ...
    def atol(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
    def atol_track_decades(self) -> float:
        ...
    @atol_track_decades.setter
    def atol_track_decades(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
    @property
...
class SolverStats:
    ...
    def n_rhs_evals(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @property
    def n_sens_err_test_fails(self) -> int:
        ...
    @n_sens_err_test_fails.setter
    def n_sens_err_test_fails(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @property
    def n_sens_nonlin_conv_fails(self) -> int:
        ...
    @n_sens_nonlin_conv_fails.setter
    def n_sens_nonlin_conv_fails(self, arg0: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
    @property
...
class SteadyStateResultCore:
    ...
    def sens_dfdp_source(self) -> str:
        ...
    @property
    def sens_jacobian_rcond(self) -> float:
        ...
    @property
    ...
    def sensitivity_data(self) -> numpy.typing.NDArray[numpy.float64]:
        ...
    @property
    def solver_jacobian_retried(self) -> bool:
        ...
    @property
    def solver_jacobian_source(self) -> str:
        ...
    @property
    def species_names(self) -> list[str]:
        ...

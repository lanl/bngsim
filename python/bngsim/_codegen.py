...
_SPECIAL_FUNCTION_C_LINES = (
    ...
    "   took under 1200.",
    "",
    "   Arguments the fraction cannot be trusted with are refused rather than",
    "   answered wrongly, by the same rule the C++ uses -- see issue #453. */",
    ...
    "   where BNG models live; b*b >= 64*|z*a| means the partial numerators are",
    "   a contraction from the first step; |z| <= 20 was clean over 3400 hostile",
    "   triples where the first failure anywhere is at 60. Anything else is",
    "   refused. Kept",
